...
//    int main() {
   int i,j,k,Ndatos1,Ndatos2,Ndatos1s2;
 ...
 //   printf("OK\n");
    ...
    double *emg1;
    Ndatos1=filesize("newtemplate1.Sound",1);
    Ndatos1s2=Ndatos1/2;
    emg1=dvector(1,Ndatos1);
    file_to_vector("newtemplate1.Sound",emg1,1,Ndatos1,1,1);
   ...
   vector_to_file("en.ch2.template1.Sound.dat",sav1,1,Ndatos1s2);
