...
//    int main() {
   int i,j,k,Ndatos1,Ndatos2,Ndatos1s2,perio,Ndatos2s2;
    ...
    sprintf(salida,"correlaciones2.%s.dat",letras);
    ...
    double *emg1;
    Ndatos1=filesize("envolventeemg2.Sound",1);
    Ndatos1s2=Ndatos1/2;
    emg1=dvector(1,Ndatos1);
    file_to_vector("envolventeemg2.Sound",emg1,1,Ndatos1,1,1);
  ...
  float *c2,*data2,*ans2,dum2;
   ...
   sav2=dvector(1,Ndatos2); 
    ...
    vector_to_file("en.sueno.Sound.dat",sav2,1,Ndatos2s2); 
