...
//    int main() {
   int i,j,k,Ndatos1,Ndatos2,Ndatos1s2,perio;
    ...
    sprintf(salida,"correlaciones4.%s.dat",letras);
 ...
 //   printf("OK\n");
    ...
    double *emg1;
    Ndatos1=filesize("newtemplate4.Sound",1);
    Ndatos1s2=Ndatos1/2;
    emg1=dvector(1,Ndatos1);
    file_to_vector("newtemplate4.Sound",emg1,1,Ndatos1,1,1);
  ...
  //  printf("\n%lg\n", emg2[1]);
   ...
   vector_to_file("en.ch2.template4.Sound.dat",sav1,1,Ndatos1s2);
